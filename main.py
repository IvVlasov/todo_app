...
from backend.core.db import create_postgres_connection_pool
...
fastapi_kwargs: dict[str, Any] = {
    ...
    "version": distribution("todo-api").version,
}
...
async def lifespan(fastapi_app: FastAPI):
    ...
    fastapi_app.connection_pool = await create_postgres_connection_pool()  # type: ignore
